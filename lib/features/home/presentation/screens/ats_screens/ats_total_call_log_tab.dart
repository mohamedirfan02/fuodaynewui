...
class TotalCallTab extends StatefulWidget {
  const TotalCallTab({super.key});

  @override
  State<TotalCallTab> createState() => _TotalCallTabState();
}

class _TotalCallTabState extends State<TotalCallTab> {
  ...
  List<GridColumn> _buildColumns() {
    ...
    return [
      ...
      GridColumn(columnName: 'CreateAt', width: 120, label: header('CreateAt')),
    ];
  }
                    ...
                    border: Border.all(
                      ...
                      color:
                          ...
                          AppColors.greyColor.withValues(
                            alpha: 0.3,
                          ), //BORDER COLORAppColors.greyColor.withOpacity(0.3),
                    ),
        ...
        if (cell.columnName == 'Status') {
          ...
          return Container(
            ...
            child: DropdownButton<String>(
              ...
              isExpanded: true,
              dropdownColor: theme
                  .secondaryHeaderColor, //AppColors.secondaryColor, // 🔹 White background for dropdown menu
              iconEnabledColor: theme
                  .textTheme
                  .headlineLarge
                  ?.color, //AppColors.titleColor,, // 🔹 Black arrow icon
