...
class SupportUnassigned extends StatelessWidget {
  const SupportUnassigned({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<GetTicketDetailsProvider>(
      builder: (_, prov, __) {
        final list = prov.grouped['unassigned'] ?? [];
        ...
        if (list.isEmpty) {
          return const Center(child: Text("No unassigned tickets."));
        }
